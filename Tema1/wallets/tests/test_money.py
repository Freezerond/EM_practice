...
class TestWallet:
    ...
    def test_change(self, wallet, money_negative):
        with pytest.raises(NegativeValueException):
            wallet[money_negative.currency] = money_negative
